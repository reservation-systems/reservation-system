...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ══ TABLES GRID ══ */
        .tables-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 9px; }
        .table-card {
        ...
        .table-card.available { border-color: var(--gold); background: rgba(244,166,35,.07); }
        ...
        .table-card.occupied { border-color: #e0e0e0; background: #f5f5f5; cursor: not-allowed; opacity: .6; }
        .table-card.selected { background: var(--gold); border-color: var(--gold); box-shadow: 0 4px 14px rgba(244,166,35,.35); }
        ...
        /* ══ MENU PANEL ══ */
        .menu-panel-locked { text-align: center; padding: 1.6rem 1rem; color: #bbb; }
        ...
        .cat-btn:hover, .cat-btn.active { background: var(--gold); border-color: var(--gold); color: var(--white); }
        ...
        .menu-item-card:hover { border-color: var(--gold); background: rgba(244,166,35,.06); transform: translateX(2px); }
        ...
        .menu-item-name { font-weight: 700; font-size: .85rem; color: var(--brown); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        ...
        .menu-item-check {
            ...
            font-size: .7rem; color: transparent; transition: .18s; background: var(--white);
        }
        .menu-item-card.selected-menu .menu-item-check { background: var(--gold); border-color: var(--gold); color: var(--white); }
        ...
        .order-summary-title { font-size: .8rem; font-weight: 700; color: var(--gold-dk); margin-bottom: 6px; display: flex; align-items: center; gap: 5px; }
        .order-summary-list { font-size: .78rem; color: #555; line-height: 1.7; }
        .order-total {
            margin-top: 6px; padding-top: 6px;
            border-top: 1px dashed rgba(244,166,35,.4);
            font-size: .85rem; font-weight: 700; color: var(--gold-dk);
            display: flex; justify-content: space-between;
        }

        /* ══ LOADING / EMPTY ══ */
        .panel-loading { text-align: center; padding: 1.8rem 0; color: #bbb; font-size: .88rem; }
        .panel-loading i { font-size: 1.6rem; display: block; margin-bottom: 8px; animation: spin 1s linear infinite; color: var(--gold); }
            ...
            <div class="reservation-form-card">
                ...
                <form id="reservationForm">
                    ...
                    <div class="payment-notice" id="paymentNotice">
                        ...
                        <strong>30% of your menu bill</strong> as a deposit.
                    </div>

                    <div class="form-group" style="margin-top:1rem;">
                        <label class="form-label">Special Request</label>
                        <textarea id="specialRequest" class="form-control" rows="3"
                                  placeholder="Dietary requirements, allergies, preferences..."></textarea>
                    </div>
...
<script>
    ...
    function requireLogin() {
        ...
        if (!customer) {
            alert("Please login first to book a reservation.");
    ...
    /* ══ SELECT TABLE — LOGIN REQUIRED ══ */
    function selectTable(tableNum, capacity) {
        if (!requireLogin()) return;  /* 🔒 BLOCK */
    ...
    /* ══ TOGGLE MENU ITEM — LOGIN REQUIRED ══ */
